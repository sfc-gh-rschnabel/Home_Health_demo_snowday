-- ============================================================================
-- Home Health SnowDay Demo - Snowflake Intelligence Agent
-- ============================================================================
...
-- ============================================================================
-- STEP 2: CREATE THE HOME_HEALTH INTELLIGENCE AGENT
-- ============================================================================

CREATE OR REPLACE AGENT SNOWFLAKE_INTELLIGENCE.AGENTS.HOME_HEALTH_OPERATIONS_AGENT
    COMMENT = 'Home Health DME Operations Intelligence Agent - Combines structured data analytics (Cortex Analyst) with policy/procedure search (Cortex Search) for denials management, sales analytics, and call center operations.'
    PROFILE = '{"display_name": "Home Health Operations Assistant", "avatar": "healthcare", "color": "#0066CC"}'
    FROM SPECIFICATION $$
    {
        "models": {
        ...
        "instructions": {
            "orchestration": "You are Home Health's operations intelligence assistant helping the revenue cycle, sales, and call center teams make data-driven decisions. Use the home_health_data tool to query structured operational data including claims, denials, sales activities, physician referrals, call center metrics, and location performance. Use the policy_search tool to find Home Health policies, procedures, billing rules, SLA standards, and compliance guidelines. When asked about targets or benchmarks, search the policy documents. When asked for specific numbers, trends, or comparisons, query the structured data. For questions about 'why' or 'what should we do', combine both tools.",
        ...
        "tools": [
            ...
            },
            {
                "tool_spec": {
                    "type": "cortex_search",
                    "name": "policy_search",
                    "description": "Search Home Health's policy documents including: claims submission guidelines and HCPCS code requirements, denial appeal procedures and timelines, Medicare CMN (Certificate of Medical Necessity) requirements, equipment authorization and delivery procedures, call center SLA standards and quality scores, sales territory assignment policies, HIPAA compliance rules, payer-specific billing rules for Medicare/Medicaid/commercial, quality metrics definitions and calculation methods, and referral management guidelines. Use this for questions about policies, procedures, targets, compliance requirements, and best practices."
                }
            }
        ],
        "tool_resources": {
...
DESCRIBE AGENT SNOWFLAKE_INTELLIGENCE.AGENTS.HOME_HEALTH_OPERATIONS_AGENT;
...
SELECT '✅ HOME_HEALTH INTELLIGENCE AGENT CREATED' as status;
